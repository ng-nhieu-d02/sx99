...
function LoTruotMega({ PlayType, functionalCallback, datCuoc, callBackNoti }) {
    const [_100so, set100So] = useState(true);
    const [NhapSo, setNhapSo] = useState(false);
    const [PlayStyle, setPlayStyle] = useState('tx5');
    ...
    const updateOdd = () => {
        if (PlayStyle === 'tx5') {
            setDachon(5);
            setOdd(2.07);
        } else if (PlayStyle === 'tx6') {
            setDachon(6);
            setOdd(2.43);
        } else if (PlayStyle === 'tx7') {
            setDachon(7);
            setOdd(2.88);
        } else if (PlayStyle === 'tx8') {
            setDachon(8);
            setOdd(3.42);
        } else if (PlayStyle === 'tx9') {
            setDachon(9);
            setOdd(4.08);
        } else {
            setDachon(10);
    ...
    const handleTypeClick = (e) => {
        ...
        if (targetElement.getAttribute('data-so')) {
            ...
            if (String(number) === 'tx5') {
                setNhapSo(false);
                set100So(true);
                setPlayStyle('tx5');
            } else if (String(number) === 'tx6') {
                setNhapSo(false);
                set100So(true);
                setPlayStyle('tx6');
            } else if (String(number) === 'tx7') {
                setNhapSo(false);
                set100So(true);
                setPlayStyle('tx7');
        ...
        <div>
            <div className="flex justify-between text-xs font-thin py-2 mobile-game-content-bet">
                <ul className="flex justify-start items-center flex-1 ul1-mobile-game-content-bet">
                    <li className="type active tx5" onClick={handleTypeClick} data-so="tx5">
                        Trượt Xiên 5
                    </li>
                    <li className="type tx6" onClick={handleTypeClick} data-so="tx6">
                        Trượt Xiên 6
                    </li>
                    <li className="type tx7" onClick={handleTypeClick} data-so="tx7">
                        Trượt Xiên 7
                    </li>
                    <li className="type tx8" onClick={handleTypeClick} data-so="tx8">
                        Trượt Xiên 8
                    </li>
                    <li className="type tx9" onClick={handleTypeClick} data-so="tx9">
                        Trượt Xiên 9
                    </li>
