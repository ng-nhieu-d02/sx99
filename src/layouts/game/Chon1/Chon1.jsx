...
function Chon1({ PlayType, functionalCallback, datCuoc, callBackNoti }) {
    const [_100so, set100So] = useState(true);
    const [NhapSo, setNhapSo] = useState(false);
    const [PlayStyle, setPlayStyle] = useState('c5a1');
    ...
    const updateOdd = () => {
        if (PlayStyle === 'c5a1') {
            setDachon(5);
            setOdd(2.31);
        } else if (PlayStyle === 'c6a1') {
            setDachon(6);
            setOdd(2.2);
        } else if (PlayStyle === 'c7a1') {
            setDachon(7);
            setOdd(2.17);
        } else if (PlayStyle === 'c8a1') {
            setDachon(8);
            setOdd(2.18);
        } else if (PlayStyle === 'c9a1') {
            setDachon(9);
            setOdd(2.24);
        } else {
            setDachon(10);
    ...
    const handleTypeClick = (e) => {
        ...
        if (targetElement.getAttribute('data-so')) {
            ...
            if (String(number) === 'c5a1') {
                setNhapSo(false);
                set100So(true);
                setPlayStyle('c5a1');
            } else if (String(number) === 'c6a1') {
                setNhapSo(false);
                set100So(true);
                setPlayStyle('c6a1');
            } else if (String(number) === 'c7a1') {
                setNhapSo(false);
                set100So(true);
                setPlayStyle('c7a1');
            } else if (String(number) === 'c8a1') {
                setNhapSo(false);
                set100So(true);
                setPlayStyle('c8a1');
            } else if (String(number) === 'c9a1') {
                setNhapSo(false);
                set100So(true);
                setPlayStyle('c9a1');
            } else if (String(number) === 'c10a1') {
                setNhapSo(false);
                set100So(true);
                setPlayStyle('c10a1');
            }
    ...
    const handleNs = async (e) => {
        ...
        arr.map((number) => {
            if (PlayStyle === 'c5a1') {
                if (number > 45 || number < 0 || isNaN(number) || arr.length > 5) {
                    callBackNoti('error', 'Cảnh báo !! bạn đang nhập sai định dạng của trò chơi !!!');
                    arr.pop();
                }
            } else if (PlayStyle === 'c6a1') {
                if (number > 45 || number < 0 || isNaN(number) || arr.length > 6) {
                    callBackNoti('error', 'Cảnh báo !! bạn đang nhập sai định dạng của trò chơi !!!');
                    arr.pop();
                }
            } else if (PlayStyle === 'c7a1') {
                if (number > 45 || number < 0 || isNaN(number) || arr.length > 7) {
                    callBackNoti('error', 'Cảnh báo !! bạn đang nhập sai định dạng của trò chơi !!!');
                    arr.pop();
                }
            } else if (PlayStyle === 'c8a1') {
                if (number > 45 || number < 0 || isNaN(number) || arr.length > 8) {
                    callBackNoti('error', 'Cảnh báo !! bạn đang nhập sai định dạng của trò chơi !!!');
                    arr.pop();
                }
            } else if (PlayStyle === 'c9a1') {
                if (number > 45 || number < 0 || isNaN(number) || arr.length > 9) {
                    callBackNoti('error', 'Cảnh báo !! bạn đang nhập sai định dạng của trò chơi !!!');
                    arr.pop();
                }
            } else {
                if (number > 45 || number < 0 || isNaN(number) || arr.length > 10) {
                    callBackNoti('error', 'Cảnh báo !! bạn đang nhập sai định dạng của trò chơi !!!');
                    arr.pop();
                }
            }
    ...
    const handleAddNumber = () => {
        ...
        if (PlayStyle === 'c5a1') {
            if (chooseNumberOk.length < 5) {
                callBackNoti('error', 'Chưa chọn số !!!!');
                return false;
            }
        } else if (PlayStyle === 'c6a1') {
            if (chooseNumberOk.length < 6) {
                callBackNoti('error', 'Chưa chọn số !!!!');
                return false;
            }
        } else if (PlayStyle === 'c7a1') {
            if (chooseNumberOk.length < 7) {
                callBackNoti('error', 'Chưa chọn số !!!!');
                return false;
            }
        } else if (PlayStyle === 'c8a1') {
        ...
        <div>
            <div className="flex justify-between text-xs font-thin py-2 mobile-game-content-bet">
                <ul className="flex justify-start items-center flex-1 ul1-mobile-game-content-bet">
                    <li className="type active c5a1" onClick={handleTypeClick} data-so="c5a1">
                        Chọn 5 Ăn 1
                    </li>
                    <li className="type c6a1" onClick={handleTypeClick} data-so="c6a1">
                        Chọn 6 Ăn 1
                    </li>
                    <li className="type c7a1" onClick={handleTypeClick} data-so="c7a1">
                        Chọn 7 Ăn 1
                    </li>
                    <li className="type c8a1" onClick={handleTypeClick} data-so="c8a1">
                        Chọn 8 Ăn 1
                    </li>
                    <li className="type c9a1" onClick={handleTypeClick} data-so="c9a1">
                        Chọn 9 Ăn 1
                    </li>
                    <li className="type c10a1" onClick={handleTypeClick} data-so="c10a1">
                        Chọn 10 Ăn 1
                    </li>
                </ul>
